...
macro(SUBPACKAGE name)
    ...
    foreach(inc ${includes})
        list(APPEND subpackage_includes ${inc})
    endforeach(inc)
    file(APPEND ${subpackage_file} "include_directories(${subpackage_includes})\n\n")
...
macro(SUBPACKAGE_LIBRARY name)
    ...
    if(subpackage_current MATCHES "${name}")
        ...
        # Add list of object files to sub-pacakge file.
        ...
        if(BUILD_SINGLE_LIB)
            if(PROJECT_LIBRARIES)
                SUBPACKAGE_ADD_LIBRARIES(${name} "${PROJECT_LIBRARIES}")
