...
macro(LIBRARY_MODULE_REQUIREMENTS moduleName packageName)
    ...
    #message(STATUS "package name = ${packageName}")
    ...
    file(WRITE ${SUBPACKAGE_FILE}
        ...
        "list(APPEND LOFAR_PACKAGES ${moduleName} ${ARGN})\n"
    )
...
#
# Note:
#       This macro is used by the SUBPACKAGE_LIBRARY and TEST_LIBRARY macros.
#===============================================================================
macro(CREATE_LIBRARY_MODULE moduleName packageName)

    if(SUBPACKAGE_CURRENT) # ?? this is for what?
...
#        )
#    endif(NOT SUBPACKAGE_GLOBAL_FILE)
