...
class TestProtocol : public AbstractProtocol
{
    ...
    public:
        ...
        virtual void send( QIODevice& device, const AbstractProtocol::StreamDataList& );
        virtual void send( QIODevice& device, const AbstractProtocol::ServiceDataList& );
        ...
        AbstractProtocol::StreamDataList lastStreamData() const { return _lastStreamData; };

    private:
        AbstractProtocol::StreamDataList _lastStreamData;
        QByteArray _last;
        QString _id;
